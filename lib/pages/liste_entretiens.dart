...
import 'package:entretiendefarsi/pages/details_entretiens.dart';
import 'package:entretiendefarsi/pages/list_recherche.dart'
    hide Entretiengeneral;
import 'package:entretiendefarsi/pages/model2.dart';
...
class _MyListState extends State<MyList> {
  ...
  Future<List<Entretiengeneral>> fetchData() async {
    final response = await http
        .get(Uri.parse('https://entretiens.defarsci.fr/api/entretiens'));
                        ...
                        return Padding(
                          ...
                          child: Card(
                              ...
                              child: ListTile(
                                ...
                                title: listEntretiensgeneral[index]
                                            .prenom
                                            .length >
                                        16
                                    ? Column(
